...
class Blueprint {
    ...
    toString() {
        return `Blueprint #${this.id}:\n - Each ore robot costs ${this.robotOreCostOre} ore.\n - Each clay robot costs ${this.robotClayCostOre} ore.\n - Each obsidian robot costs ${this.robotObsidianCostOre} ore and ${this.robotObsidianCostClay} clay.\n - Each geode robot costs ${this.robotGeodeCostOre} ore and ${this.robotGeodeCostObsidian} obsidian.`;
    }
}
...
class CollectingState {
    ...
    toString() {
        return `State t=${this.time}: Stock(Or=${this.stockOre},Cl=${this.stockClay},Ob=${this.stockObsidian},Ge=${this.stockGeode}) Robots(Or=${this.robotsOre},Cl=${this.robotsClay},Ob=${this.robotsObsidian},Ge=${this.robotsGeode})`;
    }
}
...
const solve = (blueprint, time) => {
    ...
    let maxOre = Math.max(robotOreCostOre, robotClayCostOre, robotObsidianCostOre, robotGeodeCostOre);
