...
const TIME_BEFORE_VOLCANO_ERUPTS = 26;
...
const [maximalPressureReleased_1, maximalPath_1] = exploreAllPaths(valves, STARTING_VALVE, valvesToOpen);
if (DEBUG) console.warn({maximalPressureReleased_1, maximalPath_1});

const valvesToOpenFor2ndExploration = valvesToOpen.filter(valveToOpen => !maximalPath_1.includes(valveToOpen));
if (DEBUG) console.warn({valvesToOpenFor2ndRound: valvesToOpenFor2ndExploration});

const [maximalPressureReleased_2, _] = exploreAllPaths(valves, STARTING_VALVE, valvesToOpenFor2ndExploration);

answer = maximalPressureReleased_1 + maximalPressureReleased_2;